    ...
    public partial class mig_init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogFollows", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BlogFollows_AspNetUsers_FollowedUserId",
                        column: x => x.FollowedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BlogFollows_AspNetUsers_FollowerUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlogSubscriptions_BlogPosts_BlogPostId",
                        column: x => x.BlogPostId,
                        principalTable: "BlogPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogFollows_FollowedUserId",
                table: "BlogFollows",
                column: "FollowedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_BlogFollows_FollowerUserId",
                table: "BlogFollows",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogSubscriptions_BlogPostId",
